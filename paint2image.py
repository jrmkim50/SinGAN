...
# python paint2image.py --input_name mouse-original.jpg --ref_name mouse-edited-head-detached.jpg --scale_factor 0.8 --num_layer 7 --sim_alpha 5.0 --sim_boundary 5 --sim_boundary_type start --use_attention 1 --use_attention_end 1 --paint_start_scale 2 --device 6 
